...
//        String firstClause = "";
//        firstClause += calculatePosition(i, j, RIGHT, numberLink, true);
//        firstClause += calculatePosition(i, j, UP, numberLink, true);
//        firstClause += calculatePosition(i, j, DOWN, numberLink, true);
//        firstClause += "0";
